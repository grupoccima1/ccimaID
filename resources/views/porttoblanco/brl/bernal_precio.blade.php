<x-app-layout>
    <section class="mt-2 max-w-7xl mx-auto ">
        <div class=" py-2 bg-basic-50" style="opacity: .3;">
            <h2 class=" text-center font-bold text-sm  tracking-widest " >porttoblanco bernal</h2>
        </div>
                    ...
                    <li>
                        <div class="flex justify-between mt-2">
                            <div class="flex">
                                ...
                                <a href="{{asset('file/porttoblanco/bernal/precio/promociones.pdf')}}" >
                                    Promociones (Pendientes)
                                </a>
                            </div>
                            <div class="mr-4">
                                <a download href="{{asset('file/porttoblanco/bernal/precio/promociones.pdf')}}" href="">
