                ...
                <ul class="grid grid-cols-1 gap-2 mx-6"> 
                    <li>
                        <div class="flex justify-between mt-2">
                            ...
                            <div class="mr-4">
                                <a download href="{{asset('file/porttoblanco/cimatario/precio/HAB_promociones_marzo.pdf')}}" href="">
                        ...
                        <div class="flex justify-between mt-2">
                            ...
                            <div class="mr-4">
                                <a download href="{{asset('file/porttoblanco/cimatario/precio/precio.pdf')}}" href="">
                                    <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                </a> 
                            </div>
                        </div>
