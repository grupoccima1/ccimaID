                            ...
                            <li class="text-gray-700 text-base"> 
                                <div class="flex justify-between mt-2">
                                    <div class="flex">
                                        ...
                                        <a href="{{asset('file/porttoblanco/cimatario/presentacion/cliente.pdf')}}" >
                                            Clientes
                                        </a>
                                    </div>
                                    <div class="mr-4">
                                        <a href="{{asset('file/porttoblanco/cimatario/presentacion/cliente.pdf')}}" download="">
                                ...
                                <div class="flex justify-between mt-2">
                                    <div class="flex">
                                        <img class="mr-2 w-4" src="{{asset('img/icons/pdf.svg')}}" alt="">
                                        <a href="{{asset('file/porttoblanco/cimatario/presentacion/asesor.pdf')}}" >
                                            Asesores
                                        </a>
                                    </div>
                                    <div class="mr-4">
                                        <a href="{{asset('file/porttoblanco/cimatario/presentacion/asesor.pdf')}}" download>
                                            <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                        </a> 
                                    </div>
                                </div>
