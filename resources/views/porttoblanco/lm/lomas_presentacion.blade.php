        ...
        <div class="flex justify-center	 py-4">
            ...
            <article class="mb-4 mx-8 shadow" x-data="{open : true }">
                <header class="bg-gray-200 boder border-gray-200 px-4 py-2 cursor-pointer" x-on:click="open= !open ">
                    <h2 class="font-bold text-gray-700 text-lg mx-4" > Porttoblanco </h2>
                </header>
                        ...
                        <li>
                            <div class="flex justify-between mt-2">
                                <div class="flex">
                                    ...
                                    <a href="{{asset('file/porttoblanco/lomas/presentacion/cim-lomas-asesor.pdf')}}" >
                                        CIM-LOMAS Asesores
                                    </a>
                                </div>
                                <div class="mr-4">
                                    <a href="{{asset('file/porttoblanco/lomas/presentacion/cim-lomas-asesor.pdf')}}" download="">
                            ...
                            <div class="flex justify-between mt-2">
                                <div class="flex">
                                        <img class="mr-2 w-4" src="{{asset('img/icons/pdf.svg')}}" alt="">
                                    <a href="{{asset('file/porttoblanco/lomas/presentacion/cim-lomas-cliente.pdf')}}" >
                                        CIM-LOMAS Clientes
                                    </a>
                                </div>
                                <div class="mr-4">
                                    <a href="{{asset('file/porttoblanco/lomas/presentacion/cim-lomas-cliente.pdf')}}" download="">
                                        <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                    </a> 
                                </div>
                            </div>
                    ...
                    <ul class="grid grid-cols-1 gap-2 mx-6"> 
                        <li>
                            <div class="flex justify-between mt-2">
                                <div class="flex">
                                    <img class="mr-2 w-4" src="{{asset('img/icons/pdf.svg')}}" alt="">
                                    <a href="{{asset('file/porttoblanco/lomas/presentacion/asesores.pdf')}}" >
                                        Asesores
                                    </a>
                                </div>
                                <div class="mr-4">
                                    <a href="{{asset('file/porttoblanco/lomas/presentacion/asesores.pdf')}}" download="">
                                        <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                    </a> 
                                </div>
                            </div>
                            <div class="flex justify-between mt-2">
                                <div class="flex">
                                        <img class="mr-2 w-4" src="{{asset('img/icons/pdf.svg')}}" alt="">
                                    <a href="{{asset('file/porttoblanco/lomas/presentacion/cliente.pdf')}}" >
                                        Clientes
                                    </a>
                                </div>
                                <div class="mr-4">
                                    <a href="{{asset('file/porttoblanco/lomas/presentacion/cliente.pdf')}}" download="">
                                        <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                    </a> 
                                </div>
                            </div>
