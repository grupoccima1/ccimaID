<x-app-layout>
    <section class="mt-2 max-w-7xl mx-auto ">
        <div class=" py-2 bg-basic-50" style="opacity: .3;">
            <h2 class=" text-center font-bold text-sm  tracking-widest ">LOMAS DE PORTTO BLANCO CIMATARIO  </h2>
        </div>
                ...
                <ul class="grid grid-cols-1 gap-2 mx-6"> 
                    <li>
                        <div class="flex justify-between mt-2">
                            ...
                            <div class="mr-4">
                                <a download href="{{asset('file/porttoblanco/cimatario/simulador/HAB-PB CIM_Simulador_02-may-22.xlsx')}}" href="">
