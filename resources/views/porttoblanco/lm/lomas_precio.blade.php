                    ...
                    <li>
                        <div class="flex justify-between mt-2">
                            <div class="flex">
                                ...
                                <a href="{{asset('file/porttoblanco/lomas/precio/HAB_promociones_marzo.pdf')}}" >
                                    Promociones
                                </a>
                            </div>
                            <div class="mr-4">
                                <a download href="{{asset('file/porttoblanco/lomas/precio/HAB_promociones_marzo.pdf')}}" href="">
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="flex">
                                <img class="mr-2 w-4" src="{{asset('img/icons/pdf.svg')}}" alt="">
                                <a href="{{asset('file/porttoblanco/lomas/precio/precio.pdf')}}" >
                                    Precio 
                                </a>
                            </div>
                            <div class="mr-4">
                                <a download href="{{asset('file/porttoblanco/lomas/precio/precio.pdf')}}" href="">
                                    <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                </a> 
                            </div>
                        </div>
