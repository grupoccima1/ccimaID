                    ...
                    <li>
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="flex">
                                ...
                                <a href="{{asset('file/porttoblanco/cimatario/ubicacion/porttoblanco.kmz')}}" >
                                    KMZ
                                </a>
                            </div>
                            <div class="mr-4">
                                <a href="{{asset('file/porttoblanco/cimatario/ubicacion/porttoblanco.kmz')}}" download="">
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="flex">
                                 <img class="mr-2 w-4" src="{{asset('img/icons/pdf.svg')}}" alt="">
                                <a href="{{asset('file/porttoblanco/cimatario/ubicacion/imagensatelital.jpg')}}" >
                                    Imagen Satelital
                                </a>
                            </div>
                            <div class="mr-4">
                                <a href="{{asset('file/porttoblanco/cimatario/ubicacion/imagensatelital.jpg')}}" download>
                                    <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                </a> 
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="flex">
                                 <img class="mr-2 w-4" src="{{asset('img/icons/pdf.svg')}}" alt="">
                                <a href="{{asset('file/porttoblanco/cimatario/ubicacion/mapa.jpg')}}" >
                                    Mapa Satelital
                                </a>
                            </div>
                            <div class="mr-4">
                                <a href="{{asset('file/porttoblanco/cimatario/ubicacion/mapa.jpg')}}" download>
                                    <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                </a> 
                            </div>
                        </div>
                        <div class="flex justify-between mt-2">
                            <div class="flex">
                                 <img class="mr-2 w-4" src="{{asset('img/icons/pdf.svg')}}" alt="">
                                <a href="{{asset('file/porttoblanco/cimatario/ubicacion/asoleamiento.pdf')}}" >
                                    Asoleamiento
                                </a>
                            </div>
                            <div class="mr-4">
                                <a href="{{asset('file/porttoblanco/cimatario/ubicacion/asoleamiento.pdf')}}" download>
                                    <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                </a> 
                            </div>
                        </div>
