                            ...
                            <li class="text-gray-700 text-base"> 
                                <div class="flex justify-between mt-2">
                                    <div class="flex">
                                        ...
                                        <a href="{{asset('file/navetec/celta/reglamentos/NVT-CEL_reglamento_general.pdf')}}" >
                                        Reglamento General
                                        </a>
                                    </div>
                                    <div class="mr-4">
                                        <a href="{{asset('file/navetec/celta/reglamentos/NVT-CEL_reglamento_general.pdf')}}" download="">
