                            ...
                            <li class="text-gray-700 text-base"> 
                                <div class="flex justify-between mt-2">
                                    <div class="ml-4">
                                        ...
                                        <a href="{{asset('file/navetec/celta/fichas_tecnicas/ficha_tecnica_navetec.pdf')}}" >
                                            Ficha General
                                        </a>
                                    </div>
                                    <div class="mr-4">
                                        <a href="{{asset('file/navetec/celta/fichas_tecnicas/ficha_tecnica_navetec.pdf')}}" download>
