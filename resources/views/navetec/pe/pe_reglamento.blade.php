<x-app-layout>
    <section class="mt-2 max-w-7xl mx-auto ">
        ...
        <div class="flex justify-center	 py-4">
            ...
            <h2 class=" text-center font-bold text-lg  my-4 uppercase" >Reglamento</h2>
        </div>
                            ...
                            <li class="text-gray-700 text-base"> 
                                <div class="flex justify-between mt-2">
                                    <div class="flex">
                                        ...
                                        <a href="{{asset('file/navetec/pedro/reglamentos/promociones.pdf')}}" >
                                        Reglamento General
                                        </a>
                                    </div>
                                    <div class="mr-4">
                                        <a href="{{asset('file/navetec/pedro/reglamentos/COM-PE_promociones.pdf')}}" download="">
