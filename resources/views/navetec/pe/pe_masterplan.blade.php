                    ...
                    <li>
                        <div class="flex justify-between mt-2">
                            <div class="flex">
                                ...
                                <a href="{{asset('file/navetec/pedro/masterplan/master_plan.pdf')}}" >
                                    Pedro Escobedo General
                                </a>
                            </div>
                            <div class="mr-4">
                                <a download href="{{asset('file/navetec/pedro/masterplan/master_plan.pdf')}}" href="">
