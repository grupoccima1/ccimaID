@php
    ...
    $master = [
        ['name' => 'Master Plan General ', 'url' => asset('file/navetec/gamma/masterplan/master_plan.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $disponibilidad = [
        ['name' => 'Gamma', 'url' => 'https://grupoccima.com/#!/Navetec-Gamma_Business_Park','img' => asset('img/icons/condo.svg'),],
    ]; 
$simuladores = [
    ...
    $reglamentos = [
        ['name' => 'Mantenimiento', 'url' => asset('file/navetec/gamma/reglamentos/reglamento.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $promociones = [
        ['name' => 'Promociones', 'url' => asset('file/navetec/aeropuerto/precio/promociones.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $ubicacion = [
        ['name' => 'KMZ', 'url' => asset('file/navetec/gamma/ubicacion/ubicacion.kmz'),'img' => asset('img/icons/pdf.svg'),],
        ['name' => 'Imagen Satelital', 'url' => asset('file/navetec/gamma/ubicacion/imagen_satelital.jpg'),'img' => asset('img/icons/pdf.svg'),],
        ['name' => 'Asoleamiento', 'url' => asset('file/navetec/gamma/ubicacion/asoleamiento.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $presentacion = [
    ...
    $fichas = [
        ['name' => 'Gamma','url' => asset('file/navetec/gamma/fichas_tecnicas/ficha_tecnica.pdf'), 'img' => asset('img/icons/pdf.svg'),],
    ];
     $videos = [
    ...
    $vrs = [
        ['name' => 'Recorridos Virtuales Navetec', 'url' => asset('file/navetec/gamma/vr/recorridosvr.pdf') ,'img' => asset('img/icons/pdf.svg'),],
    ...
    <section class=" max-w-7xl mx-auto ">
        <div class="">
            <div class="mt-2 py-2 bg-basic-50" style="opacity: .3;">
                <h2 class=" text-center font-bold text-sm  tracking-widest uppercase">gamma</h2>
            </div>
        </div>
