                            ...
                            <li class="text-gray-700 text-base"> 
                                ...
                                <div class="flex justify-between mt-2">
                                    <div class="flex">
                                        ...
                                        <a href="{{asset('file/navetec/server/precio/promociones.pdf')}}" >
                                            Promociones
                                        </a>
                                    </div>
                                    <div class="mr-4">
                                        <a href="{{asset('file/navetec/server/precio/promociones.pdf')}}" download="">
                                ...
                                {{-- <div class="flex justify-between mt-2">
                                    <div class="flex">
                                          <img class="mr-2 w-4" src="{{asset('img/icons/pdf.svg')}}" alt="">
                                        <a href="{{asset('file/navetec/server/precio/precio.pdf')}}" >
                                            Precio
                                        </a>
                                    </div>
                                    <div class="mr-4">
                                        <a href="{{asset('file/navetec/server/precio/precio.pdf')}}" download>
                                            <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                        </a> 
                                    </div>
                                </div> --}}
