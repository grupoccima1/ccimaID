@php
    ...
    $master = [
        ['name' => 'Master Plan General ', 'url' => asset('file/navetec/calamanda/masterplan/master_plan.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $disponibilidad = [
        ['name' => 'Calamanda', 'url' => 'https://grupoccima.com/#!/Navetec-Calamanda_Business_Park','img' => asset('img/icons/condo.svg'),],
    ]; 
    $simuladores = [
    ...
    $reglamentos = [
        ['name' => 'Reglamento General', 'url' => asset('file/navetec/calamanda/reglamentos/reglamento_general.pdf'),'img' => asset('img/icons/pdf.svg'),],
        ['name' => 'Reglamento interno', 'url' => asset('file/navetec/calamanda/reglamentos/reglamento_interno.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $promociones = [
        ['name' => 'Promociones', 'url' => asset('file/navetec/aeropuerto/precio/promociones.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $ubicacion = [
        ['name' => 'KMZ', 'url' => asset('file/navetec/calamanda/ubicacion/ubicacion.kmz'),'img' => asset('img/icons/pdf.svg'),],
        ['name' => 'Asoleamiento', 'url' => asset('file/navetec/calamanda/ubicacion/asoleamiento.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $presentacion = [
    ...
    $fichas = [
        ['name' => 'Ficha General','url' => asset('file/navetec/calamanda/fichas_tecnicas/ficha_tecnica_navetec.pdf'), 'img' => asset('img/icons/pdf.svg'),],
    ];
    $pago = [
        ['name' => 'Procedimiento de Pago','url' => asset('file/navetec/calamanda/pago/procedimiento_de_pago_calamanda.pdf'), 'img' => asset('img/icons/pdf.svg'),],
    ];
      $videos = [
     
         ['name' => 'Calamanda', 'url' => "https://www.youtube.com/watch?v=i00cdTCABqc",'img' => asset('img/icons/pdf.svg'),],
    ...
    $vrs = [
        ['name' => 'Recorridos Virtuales Navetec', 'url' => asset('file/navetec/calamanda/vr/recorridosvr.pdf') ,'img' => asset('img/icons/pdf.svg'),],
    ...
    <section class=" max-w-7xl mx-auto ">
        <div class="">
            <div class="mt-2 py-2 bg-basic-50" style="opacity: .3;">
                <h2 class=" text-center font-bold text-sm  tracking-widest uppercase">Calamanda</h2>
            </div>
        </div>
