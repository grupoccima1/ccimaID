                            ...
                            <li class="text-gray-700 text-base"> 
                                <div class="flex justify-between mt-2">
                                    <div class="ml-4">
                                        ...
                                        <a href="{{asset('file/navetec/santa/precio/promociones.pdf')}}" >
                                            Promociones
                                        </a>
                                    </div>
                                    <div class="mr-4">
                                        <a href="{{asset('file/navetec/santa/precio/promociones.pdf')}}" download="">
                                ...
                                {{-- <div class="flex justify-between mt-2">
                                    <div class="ml-4">
                                        <img class="mr-2" src="" alt="">
                                        <a href="{{asset('file/navetec/aeropuerto/precio/precio.pdf')}}" >
                                            Precio
                                        </a>
                                    </div>
                                    <div class="mr-4">
                                        <a href="{{asset('file/navetec/aeropuerto/precio/precio.pdf')}}" download>
                                            <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                        </a> 
                                    </div>
                                </div> --}}
