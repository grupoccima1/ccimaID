@php
    $master = [
        ['name' => 'Master Plan General ', 'url' => asset('file/navetec/aeropuerto/masterplan/master_plan.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $disponibilidad = [
        ['name' => 'Aeropuerto', 'url' => 'https://grupoccima.com/#!/Navetec-Aeropuerto_Business_Park','img' => asset('img/icons/condo.svg'),],
    ]; 
    $simuladores = [
    ...
    $reglamentos = [
        ['name' => 'Mantenimiento', 'url' => asset('file/navetec/aeropuerto/reglamentos/reglamento_general.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $promociones = [
        ['name' => 'Promociones', 'url' => asset('file/navetec/aeropuerto/precio/promociones.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $ubicacion = [
        ['name' => 'KMZ', 'url' => asset('file/navetec/aeropuerto/ubicacion/ubicacion.kmz'),'img' => asset('img/icons/pdf.svg'),],
        ['name' => 'Imagen Satelital', 'url' => asset('file/navetec/aeropuerto/ubicacion/imagen_satelital.jpg'),'img' => asset('img/icons/pdf.svg'),],
        ['name' => 'Asoleamiento', 'url' => asset('file/navetec/aeropuerto/ubicacion/asoleamiento.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $presentacion = [
        ['name' => 'Presentacion de Clientes', 'url' => asset('file/navetec/aeropuerto/presentacion/asesores.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $flyers = [
        ['name' => 'Digital','url' => asset('file/navetec/aeropuerto/flyer/DS_flyer_navetec_by_ccima.jpg'),'img' => asset('img/icons/pdf.svg'),],
        ['name' => 'Carta','url' => asset('file/navetec/aeropuerto/flyer/promociones_carta.pdf'),'img' => asset('img/icons/pdf.svg'),],
        ['name' => 'Tabloide','url' => asset('file/navetec/aeropuerto/flyer/promociones_tabloide.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];

    $fichas = [
        ['name' => 'Aeropuerto','url' => asset('file/navetec/aeropuerto/fichas_tecnicas/ficha_tecnica_navetec.pdf'), 'img' => asset('img/icons/pdf.svg'),],
    ];
    $pago = [
     ...
     $vrs = [
        ['name' => 'Recorridos Virtuales Navetec', 'url' => asset('file/navetec/aeropuerto/vr/recorridosvr.pdf') ,'img' => asset('img/icons/pdf.svg'),],
    ...
    <section class=" max-w-7xl mx-auto ">
        <div class="">
            <div class="mt-2 py-2 bg-basic-50" style="opacity: .3;">
                <h2 class=" text-center font-bold text-sm  tracking-widest uppercase">aeropuerto</h2>
            </div>
        </div>
                ...
                <div class="px-2 rounded-b-2xl" x-show="open">
                    <ul class="grid grid-cols-1 gap-2 mb-2">
                        ...
                        <article class="" x-data="{open : false}">
                            <header class="bg-gray-200 rounded-t-lg boder border-gray-200 px-4 py-2 cursor-pointer flex" x-on:click="open= !open ">
                                <img class="w-6" src="{{ asset('img/icons/fichatecnica.svg')}}" alt="">
                                <h2 class="text-sm text-gray-700  p-2 uppercase">fichas tecnicas</h2>
                            </header>
                            <div class="py-2 rounded-b-2xl shadow-md"  x-show="open">
                                <ul class="grid grid-cols-1 gap-2 mx-6"> 
