@php
    $master = [
        ['name' => 'Master Plan General', 'url' => asset('file/navetec/celta/masterplan/masterplan.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $disponibilidad = [
        ['name' => 'Celta', 'url' => 'https://grupoccima.com/#!/Navetec-Celta_Business_Park','img' => asset('img/icons/condo.svg'),],
    ]; 
    $simuladores = [
    ...
    $reglamentos = [
        ['name' => 'Reglamento Construccion', 'url' => asset('file/navetec/celta/reglamento/celta_construccion.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $promociones = [
        ['name' => 'Promociones', 'url' => asset('file/navetec/aeropuerto/precio/promociones.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $ubicacion = [
        ['name' => 'KMZ', 'url' => asset('file/navetec/celta/ubicacion/ubicacion.kmz'),'img' => asset('img/icons/pdf.svg'),],
        ['name' => 'Asoleamiento', 'url' => asset('file/navetec/celta/ubicacion/asoleamiento.pdf'),'img' => asset('img/icons/pdf.svg'),],
    ];
    $presentacion = [
    ...
    $fichas = [
        ['name' => 'Ficha General','url' => asset('file/navetec/celta/fichas_tecnicas/ficha.pdf'), 'img' => asset('img/icons/pdf.svg'),],
    ];
    $pago = [
        ['name' => 'Procedimiento de Pago','url' => asset('file/navetec/celta/pago/procedimiento_de_pago_celta.pdf'), 'img' => asset('img/icons/pdf.svg'),],
    ];
      $videos = [

             ['name' => 'Celta', 'url' => "https://www.youtube.com/watch?v=QR-RJxsnMd0",'img' => asset('img/icons/pdf.svg'),],
   
    ];
    $vrs = [
        ['name' => 'Recorridos Virtuales Navetec', 'url' => asset('file/navetec/celta/vr/recorridosvr.pdf') ,'img' => asset('img/icons/pdf.svg'),],
    ...
    <section class=" max-w-7xl mx-auto ">
        <div class="">
            <div class="mt-2 py-2 bg-basic-50" style="opacity: .3;">
                <h2 class=" text-center font-bold text-sm  tracking-widest uppercase">Celta</h2>
            </div>
        </div>
