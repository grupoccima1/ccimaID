                    ...
                    <li>
                        <div class="flex justify-between mt-2">
                            <div class="ml-4">
                                ...
                                <a href="{{asset('file/navetec/gammaii/masterplan/master_plan.pdf')}}" >
                                    General
                                </a>
                            </div>
                            <div class="mr-4">
                                <a download href="{{asset('file/navetec/gammaii/masterplan/master_plan.pdf')}}" href="">
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="ml-4">
                                <img class="mr-2" src="" alt="">
                                <a href="{{asset('file/navetec/gammaii/masterplan/master_plan_etapa_I.pdf')}}" >
                                    Etapa I 
                                </a>
                            </div>
                            <div class="mr-4">
                                <a download href="{{asset('file/navetec/gammaii/masterplan/master_plan_etapa_I.pdf')}}" href="">
                                    <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                </a> 
                            </div>
                        </div>
                        <div class="flex justify-between mt-2">
                            <div class="ml-4">
                                <img class="mr-2" src="" alt="">
                                <a href="{{asset('file/navetec/gammaii/masterplan/master_plan_etapa_II.pdf')}}" >
                                    Etapa I 
                                </a>
                            </div>
                            <div class="mr-4">
                                <a download href="{{asset('file/navetec/gammaii/masterplan/master_plan_etapa_II.pdf')}}" href="">
                                    <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                </a> 
                            </div>
                        </div>
