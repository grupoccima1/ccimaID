<x-app-layout>
    <section class=" max-w-7xl mx-auto ">
        ...
        <div class="flex justify-center	 py-4">
            ...
            <h2 class=" text-center font-bold text-lg  my-4 uppercase" >Promociones</h2>
        </div>
                            ...
                            <li class="text-gray-700 text-base"> 
                                <div class="flex justify-between mt-2">
                                    <div class="ml-4">
                                        ...
                                        <a href="{{asset('file/navetec/gammaii/precio/promociones.pdf')}}" >
                                            Promociones
                                        </a>
                                    </div>
                                    <div class="mr-4">
                                        <a href="{{asset('file/navetec/gammaii/precio/promociones.pdf')}}" download="">
