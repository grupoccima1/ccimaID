                    ...
                    <li>
                        <div class="flex justify-between mt-2">
                            <div class="ml-4">
                                ...
                                <a href="{{asset('file/navetec/beta/masterplan/master_plan_area_comercial.pdf')}}" >
                                    Area Comercial
                                </a>
                            </div>
                            <div class="mr-4">
                                <a download href="{{asset('file/navetec/beta/masterplan/master_plan_area_comercial.pdf')}}" href="">
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="ml-4">
                                <img class="mr-2" src="" alt="">
                                <a href="{{asset('file/navetec/beta/masterplan/master_plan_locales.pdf')}}" >
                                    Locales Comerciales
                                </a>
                            </div>
                            <div class="mr-4">
                                <a download href="{{asset('file/navetec/beta/masterplan/master_plan_locales.pdf')}}" href="">
                                    <img class="h-4 " src="{{asset('img/icons/download.svg')}}" alt="">
                                </a> 
                            </div>
                        </div>
